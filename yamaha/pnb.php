      ...
      <div id="wrapper">
         ...
         <div id="mainframe">
            <div class="sub_frame">
               ...
               <?php 
                  // If category variable is empty, don't display sort option
                  if ($CATEGORY != '') {
               ?>
               ...
               <div class="productframe">
                  ...
                  <div class="product">
                     ...
                     <?php } else { ?>
                     <span class="product-discount-label" style="background-color:#FFF; color:#FFF">-<?php echo  $data['ProductDiscountAmount']; ?> %</span>
                     <?php } ?>
